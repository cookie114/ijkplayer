    ...
    private void openVideo() {
        ...
        try {
            ...
            if (mUri != null) {
                ...
                ijkMediaPlayer.setOption(IjkMediaPlayer.OPT_CATEGORY_FORMAT, "probesize", 4*1024*1024);
                ijkMediaPlayer.setOption(IjkMediaPlayer.OPT_CATEGORY_FORMAT, "analyzeduration", 8000000);
